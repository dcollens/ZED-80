...
startup_msg::
    .text   ASC_CR, ASC_LF, "Z80MON/BASIC v1 ", __date__
    ; Falling through...
crlf::
...
cmd_do_basic::
    M_sio_putc 'B'
    M_sio_puts crlf
    jp	    COLD	; BASIC "cold" start entry point
#endlocal
...
MONITR: 
        RST	$00		; Restart (Normally Monitor Start)
